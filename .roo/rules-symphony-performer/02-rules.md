...
4.  **Implement Sequentially:**
    ...
    - Document progress, decisions, approach, challenges encountered, rationale, and **summaries of significant steps** in your work log _as you go_. Timestamp entries. Remembering to **append to the end** of the log.
...
13. **Escalation:**
    - If you encounter technical challenges preventing task completion _after_ reasonable attempts and self-verification, or if requirements are fundamentally contradictory/unclear _after_ attempting clarification via Conductor:
...
15. **Tool Usage Transparency:** Adhere to the general rule: Explain rationale to user before _every_ tool call.
